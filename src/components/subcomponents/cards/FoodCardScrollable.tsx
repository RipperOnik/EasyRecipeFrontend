...
function FoodCardScrollable(props: DetailedPage) {
  ...
  return (
    <Link to={`/recipe/${props.id}`} onClick={() => dispatch(navigateToDetailedPage({
      id: props.id,
      ...
      >
        <img
          ...
          style={{ height: "250px" }}
        />
        <div className="card-body custom-card" style={{ whiteSpace: "normal" }}>
          <h5
          ...
          <Rating averageRating={props.averageRating ?? 0} totalReviewCount={props.totalReviewCount ?? 0}/>
